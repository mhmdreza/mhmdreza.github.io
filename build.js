  ...
  <section id="contact" style="max-width:1180px;margin:0 auto;padding:90px 32px 110px;scroll-margin-top:90px;">
    <div data-reveal="" class="r-contact" style="border:1px solid var(--border);border-radius:24px;background:var(--surface);padding:64px 48px;text-align:center;position:relative;overflow:hidden;">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:14px;justify-content:center;margin-top:36px;position:relative;">
        ...
        <a href="${esc(d.links.linkedin)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:9px;padding:14px 24px;border-radius:12px;border:1px solid var(--border);background:var(--surfaceHi);color:var(--fg);font-weight:600;font-size:15px;transition:transform .2s,border-color .2s;">LinkedIn</a>
        <a href="${esc(d.links.github)}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:9px;padding:14px 24px;border-radius:12px;border:1px solid var(--border);background:var(--surfaceHi);color:var(--fg);font-weight:600;font-size:15px;transition:transform .2s,border-color .2s;">GitHub</a>
